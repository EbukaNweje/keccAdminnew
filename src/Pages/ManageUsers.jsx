...
const ManageUsers = () => {
    ...
    const getAllUserData = () => {
        const url = "https://keec-new-site-back-end.vercel.app/api/alluserdata";
        axios
            .get(url)
            .then((response) => {
...
// };
    ...
    const adminAproveEmailSand = async (email) => {
        ...
        fetch('https://keecnewsitebackend-1.onrender.com/api/adminAproveEmailSand', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
    ...
    const Verify = (id) => { 
            const url = `https://keec-new-site-back-end.vercel.app/api/UserVerify/${id}`;
            axios.patch(url)
                .then((response) => {
