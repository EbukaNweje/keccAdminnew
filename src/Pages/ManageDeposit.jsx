...
const ManageDeposit = () => {
    ...
    const acceptDeposit = (depositId) => {
        const url = `https://keec-new-site-back-end.vercel.app/api/confirm-deposit/${depositId}`;
        axios.post(url)
            .then((response) => {
    ...
    const getallDeposit = () => {
        const url = "https://keec-new-site-back-end.vercel.app/api/alldeposit";
        axios.get(url)
            .then((response) => {
    ...
    const deleteItem = async (depositId) => {
          axios.delete(`https://keec-new-site-back-end.vercel.app/api/deleteoneDeposit/${depositId}`)
          .then((response)=>{
