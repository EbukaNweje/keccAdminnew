...
const ManageWithdrawal = () => {
  ...
  const sendSignUpEmail = async (id) => {
    const urlemail = `https://keecnewsitebackend-1.onrender.com/api/confirmwithdrawalemailsend/${id}`
    axios.post(urlemail)
       .then(response => {
    ...
    const acceptDeposit = (withdrawId) => {
        const url = `https://keec-new-site-back-end.vercel.app/api/confirm-withdrawal/${withdrawId}`;
        axios.post(url)
            .then((response) => {
    ...
    const getallDeposit = () => {
        const url = "https://keec-new-site-back-end.vercel.app/api/allwithdrawal";
        axios.get(url)
            .then((response) => {
    ...
    const deleteItem = async (withdrawId) => {
        axios.delete(`https://keec-new-site-back-end.vercel.app/api/deleteoneWithdraw/${withdrawId}`)
        .then((response)=>{
          console.log(response)
          toast.success(response.data.message);
          window.location.reload();
